    ...
    <x-mary-main full-width>
        ...
        <x-slot:sidebar drawer="main-drawer" collapsible  class="bg-base-200">
            ...
            <x-mary-menu activate-by-route>
                ...
                <x-mary-menu-item title="Categories" icon="o-document" :link="route('categories')" wire:navigate />
                <x-mary-menu-item title="Posts" icon="o-document" :link="route('posts')" wire:navigate.hover />
