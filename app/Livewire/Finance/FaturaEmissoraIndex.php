...
class FaturaEmissoraIndex extends Component
{
    ...
    {
        $registro = FaturaEmissora::find($id);
    ...
    {
        FaturaEmissora::find($id)->delete();
        $this->modalConfirmDelete = false;
        $this->success('Registro excluído com sucesso!');
    }

    /* Dados da tabela */
    public function fatura_emissoras()
    {
    ...
    public function render()
    {
        return view('livewire.finance.fatura-emissora-index', [
            ...
            'fatura_emissoras' => $this->fatura_emissoras(),
        ]);
    }
}
